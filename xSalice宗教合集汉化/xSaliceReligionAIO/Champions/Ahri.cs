    ...
    class Ahri : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按键", "Key");{
                ...
                key.AddItem(new MenuItem("charmCombo", "连招如果魅惑到用Q",true).SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("rSpeed", "决斗使用所有R",true).SetValue(true));
                //add to menu
