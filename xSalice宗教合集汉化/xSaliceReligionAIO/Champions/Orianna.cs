        ...
        private void LoadMenu()
        {
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                ...
                var qMenu = new Menu("Q技能", "QSpell");{
                    qMenu.AddItem(new MenuItem("qHit", "连招Q命中",true).SetValue(new Slider(3, 1, 3)));
                    qMenu.AddItem(new MenuItem("qHit2", "骚扰Q命中",true).SetValue(new Slider(3, 1, 4)));
                    spellMenu.AddSubMenu(qMenu);
                }
                //W
                var wMenu = new Menu("W技能", "WSpell");
                {
                    wMenu.AddItem(new MenuItem("autoW", "W命中",true).SetValue(new Slider(2, 1, 5)));
                ...
                var eMenu = new Menu("E技能", "ESpell");
                {
                    ...
                    eMenu.SubMenu("shield").AddItem(new MenuItem("eAllyIfHP", "如果生命 < %", true).SetValue(new Slider(40)));
                ...
                var rMenu = new Menu("R技能", "RSpell"); {
                    rMenu.AddItem(new MenuItem("autoR", "R命中",true).SetValue(new Slider(3, 1, 5)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("autoRCombo", "R命中",true).SetValue(new Slider(2, 1, 5)));
            ...
            var farm = new Menu("补兵", "Farm");
            {
                ...
                farm.AddItem(new MenuItem("qFarm", "Q/W小兵数", true).SetValue(new Slider(3, 0, 5)));
            ...
            //Damage after combo:
            MenuItem dmgAfterComboItem = new MenuItem("DamageAfterCombo", "显示组合伤害",true).SetValue(true);
