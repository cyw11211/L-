    ...
    class Akali : Champion
    {
        ...
        private void LoadMenu()
        {
            var key = new Menu("按键", "Key");
            {
                ...
                key.AddItem(new MenuItem("LastHitQ", "使用Q补兵",true).SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                ...
                {
                    wMenu.AddItem(new MenuItem("useW_enemyCount", "敌人>X个使用W",true).SetValue(new Slider(3, 1, 5)));
                ...
                {
                    eMenu.AddItem(new MenuItem("E_On_Killable", "E击杀",true).SetValue(true));
                    eMenu.AddItem(new MenuItem("E_Energy", "如果E能量", true).SetValue(new Slider(100, 0, 200)));
                ...
                var rMenu = new Menu("R菜单", "RMenu");
                {
                    ...
                    rMenu.AddItem(new MenuItem("R_Min", "使用R的最小范围", true).SetValue(new Slider(400, 50, 700)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("Combo_Switch", "切换模式键",true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            ...
            var farm = new Menu("清线", "LaneClear");
            {
                ...
                farm.AddItem(new MenuItem("LaneClear_useE_minHit", "最少击中X个小兵使用E",true).SetValue(new Slider(2, 1, 6)));
                //add to menu
