    ...
    class Corki : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("Always_Use", "使用技能后普攻",true).SetValue(true));
                combo.AddItem(new MenuItem("qHit", "Q/R命中",true).SetValue(new Slider(3, 1, 3)));
            ...
            var harass = new Menu("消耗", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q/R命中",true).SetValue(new Slider(3, 1, 3)));
