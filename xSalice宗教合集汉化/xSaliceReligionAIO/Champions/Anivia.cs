        ...
        private void LoadMenu()
        {
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                var qMenu = new Menu("Q菜单", "QMenu");
                {
                    ...
                    qMenu.AddItem(new MenuItem("detonateQ2", "Q后面的敌人",true).SetValue(true));
                    spellMenu.AddSubMenu(qMenu);
                }

                var wMenu = new Menu("W菜单", "WMenu");
                {
                    wMenu.AddItem(new MenuItem("wallKill", "冰墙阻挡敌人",true).SetValue(true));
            ...
            var farm = new Menu("补兵", "Farm");
            {
                ...
                farm.AddItem(new MenuItem("UseRFarm", "使用R",true).SetValue(false));
            ...
            {
                misc.AddItem(new MenuItem("UseInt", "打断敌人技能",true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "W防突进",true).SetValue(true));
