        ...
        private void LoadMenu()
        {
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                var qMenu = new Menu("Q菜单", "QMenu");
                {
                    ...
                    qMenu.AddItem(new MenuItem("Q_Over_Heat", "智能过热Q击杀",true).SetValue(true));
                ...
                var wMenu = new Menu("W菜单", "WMenu");
                {
                    ...
                    wMenu.AddItem(new MenuItem("W_Always", "总是连招/骚扰使用W",true).SetValue(false));
                    wMenu.AddItem(new MenuItem("W_Block_Spell", "使用W抵挡技能",true).SetValue(true));
                ...
                var eMenu = new Menu("E菜单", "EMenu");
                {
                    ...
                    eMenu.AddItem(new MenuItem("E_Over_Heat", "智能E过热击杀",true).SetValue(true));
                    spellMenu.AddSubMenu(eMenu);
                }

                var rMenu = new Menu("R菜单", "RMenu");
                {
                    rMenu.AddItem(new MenuItem("R_If_Enemy_Count", "敌人>X自动大6=关闭",true).SetValue(new Slider(4, 1, 6)));
                    rMenu.AddItem(new MenuItem("R_If_Enemy_Count_Combo", "连招敌人>X自动大6=关闭",true).SetValue(new Slider(3, 1, 6)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("qHit", "E命中几率",true).SetValue(new Slider(3, 1, 3)));
            ...
            var harass = new Menu("消耗", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "E命中几率",true).SetValue(new Slider(3, 1, 4)));
                //add to menu
            ...
            var drawMenu = new Menu("显示", "Drawing");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_R_Pred", "显示R最佳路线",true).SetValue(true));
