    ...
    class Fiora : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按键", "Key");
            {
                ...
                key.AddItem(new MenuItem("Combo_Switch", "切换模式键",true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                ...
                var wMenu = new Menu("W菜单", "WMenu");
                {
                    ...
                    wMenu.AddItem(new MenuItem("W_Tower", "不在塔下W", true).SetValue(true));
                ...
                {
                    rMenu.AddItem(new MenuItem("R_If_HP", "血量<=使用R",true).SetValue(new Slider(20)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("Combo_mode", "连招模式",true).SetValue(new StringList(new[] { "Normal", "Q-AA-Q-AA-Ult" })));
            ...
            var drawMenu = new Menu("显示", "Drawing");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_R_Killable", "显示R可击杀",true).SetValue(true));
