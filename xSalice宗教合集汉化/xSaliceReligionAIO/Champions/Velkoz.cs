    ...
    class Velkoz : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按键", "Key");
            {
                ...
                key.AddItem(new MenuItem("R_Mouse", "R鼠标方向",true).SetValue(new KeyBind("R".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var spell = new Menu("技能", "Spell");
            {
                ...
                {
                    rMenu.AddItem(new MenuItem("rAimer", "R 目标", true).SetValue(new StringList(new[] { "自动", "鼠标方向" })));
                    rMenu.AddSubMenu(new Menu("不使用R", "DontUlt"));
            ...
            var draw = new Menu("范围显示", "Drawings"); { 
                ...
                draw.AddItem(new MenuItem("drawUlt", "显示大可击杀", true).SetValue(true));
