    ...
    class Zed : Champion
    {
        ...
        private void LoadMenu()
        {
            var key = new Menu("按键", "Key");
            {
                ...
                key.AddItem(new MenuItem("Switch_1", "线路模式",true).SetValue(new KeyBind("U".ToCharArray()[0], KeyBindType.Press)));
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                var wMenu = new Menu("W菜单", "WMenu");
                {
                    ...
                    wMenu.AddItem(new MenuItem("W_Follow_Combo", "线路模式跟随W")).SetValue(false));
                ...
                {
                    rMenu.AddItem(new MenuItem("R_Place_line", "R范围到目标后",true).SetValue(new Slider(400, 250, 550)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("Combo_mode", "连招模式", true).SetValue(new StringList(new[] { "Normal", "Line Combo", "Coax", "Ult no W", "Normal With Ult" })));
                ...
                combo.AddItem(new MenuItem("Prioritize_Q", "比W->Q模式先Q",true).SetValue(true));
            ...
            var misc = new Menu("杂项", "Misc");
            {
                ...
                misc.AddItem(new MenuItem("Use_W_KS", "击杀使用W", true).SetValue(true));
                misc.AddItem(new MenuItem("AutoE", "范围内自动E", true).SetValue(true));
                //add to menu
