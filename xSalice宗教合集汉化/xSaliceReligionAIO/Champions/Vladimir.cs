    ...
    class Vladimir : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("useR_Hit", "R命中",true).SetValue(new Slider(3, 1, 5)));
                //add to menu
            ...
            {
                miscMenu.AddItem(new MenuItem("W_Gap_Closer", "使用W防突进",true).SetValue(true));
                miscMenu.AddItem(new MenuItem("smartKS", "智能击杀", true).SetValue(true));
                miscMenu.AddItem(new MenuItem("R_KS", "R击杀", true).SetValue(true));
