    ...
    class Zyra : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按键", "Key");
            {
                ...
                key.AddItem(new MenuItem("Escape", "E逃跑", true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("R_Min", "敌人数 >= 自动大 , 6 = 关闭", true).SetValue(new Slider(3, 1, 6)));
                //add to menu
            ...
            {
                misc.AddItem(new MenuItem("E_GapCloser", "使用E防止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("smartKS", "智能击杀", true).SetValue(true));
                misc.AddItem(new MenuItem("Auto_Bloom", "敌人靠近自动让种子生长", true).SetValue(true));
                //add to menu
            ...
            {
                drawing.AddItem(new MenuItem("Draw_Disabled", "关闭所有", true).SetValue(false));
                drawing.AddItem(new MenuItem("Draw_Q", "Q范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_W", "Q范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_E", "E范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_R", "R范围", true).SetValue(true));
