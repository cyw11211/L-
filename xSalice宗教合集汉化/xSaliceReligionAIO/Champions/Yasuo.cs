    ...
    class Yasuo : Champion
    {
        ...
        private void LoadMenu()
        {
            var key = new Menu("按键", "Key");
            {
                ...
                key.AddItem(new MenuItem("Flee", "E逃跑", true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                var qMenu = new Menu("Q菜单", "QMenu");
                {
                    ...
                    qMenu.AddItem(new MenuItem("Q_Stack", "自动叠加三段Q切换", true).SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
                    qMenu.AddItem(new MenuItem("Q_thirdE", "优先 E->三段 Q 再Q", true).SetValue(true));
                ...
                {
                    eMenu.AddItem(new MenuItem("E_Min_Dist", "最小距离使用E", true).SetValue(new Slider(250, 1, 475)));
                    //e Evade
                    ...
                    eMenu.AddItem(new MenuItem("E_GapClose", "使用E接近敌人", true).SetValue(true));
                ...
                {
                    rMenu.AddItem(new MenuItem("R_If_Killable", "如果敌人可击杀R", true).SetValue(true));
                    rMenu.AddItem(new MenuItem("delayR", "延迟使用R杀死敌人", true).SetValue(true));
                    rMenu.AddItem(new MenuItem("R_MEC", "如果 >= 敌人数自动R, 0 = 关闭", true).SetValuee(new Slider(3, 0, 5)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("qHit", "Q命中几率", true).SetValue(new Slider(2, 1, 3)));
                combo.AddItem(new MenuItem("UseECombo", "使用E", true).SetValue(true));
                combo.AddItem(new MenuItem("UseRCombo", "使用R", true).SetValue(true));
                combo.AddItem(new MenuItem("ComboR_MEC", "如果 >= 敌人数R", true).SetValue(new Slider(3, 1, 5)));
                //add to menu
            ...
            var harass = new Menu("消耗", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q命中几率", true).SetValue(new Slider(2, 1, 3)));
            ...
            var farm = new Menu("清兵", "Farming");
            {
                ...
                farm.AddItem(new MenuItem("UseQ3Farm", "使用3段Q补兵", true).SetValue(true));
                ...
                farm.AddItem(new MenuItem("LaneClear_useQ_minHit", "Q 最少命中", true).SetValue(new Slider(2, 1, 6)));
                //add to menu
            ...
            var misc = new Menu("杂项", "Misc");
            {
                ...
                misc.AddItem(new MenuItem("predMode", "预判模式，, 关闭 = 快速, 打开 = 准确", true).SetValue(true));
