    ...
    class Azir : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按键", "Key");
            {
                ...
                key.AddItem(new MenuItem("insec", "锁定目标",true).SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Press)));
                ...
                key.AddItem(new MenuItem("point", "逃生点标签（延迟逃生专用）", true).SetValue(new KeyBind("M".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var spell = new Menu("技能", "Spell");
            {
                ...
                var qMenu = new Menu("Q技能", "QSpell"); { 
                    qMenu.AddItem(new MenuItem("qOutRange", "只在敌人超出范围",true).SetValue(false));
                    qMenu.AddItem(new MenuItem("qExtend", "使用最大Q范围",true).SetValue(true));
                    qMenu.AddItem(new MenuItem("qHit", "Q命中",true).SetValue(new Slider(3, 1, 3)));
                    spell.AddSubMenu(qMenu);
                }
                //W Menu
                var wMenu = new Menu("W技能", "WSpell"); {
                    wMenu.AddItem(new MenuItem("wAtk", "总是攻击敌人",true).SetValue(true));
                    wMenu.AddItem(new MenuItem("wQ", "使用WQ消耗",true).SetValue(true));
                    spell.AddSubMenu(wMenu);
                }
                //E Menu
                var eMenu =  new Menu("E技能", "ESpell");
                {
                ...
                var rMenu = new Menu("R技能", "RSpell");{
                    ...
                    rMenu.AddItem(new MenuItem("rWall", "把敌人大到墙上",true).SetValue(true));
            ...
            {
                killSteal.AddItem(new MenuItem("smartKS", "智能击杀",true).SetValue(true));
                killSteal.AddItem(new MenuItem("eKS", "使用E击杀",true).SetValue(false));
                killSteal.AddItem(new MenuItem("wqKS", "使用WQ击杀",true).SetValue(true));
                killSteal.AddItem(new MenuItem("qeKS", "使用WQE击杀",true).SetValue(false));
                killSteal.AddItem(new MenuItem("rKS", "使用R击杀",true).SetValue(true));
            ...
            var farm = new Menu("补兵", "Farm");
            {
                ...
                farm.AddItem(new MenuItem("qFarm", "小兵大于X个",true).SetValue(new Slider(3, 0, 5)));
            ...
            {
                misc.AddItem(new MenuItem("UseInt", "使用E打断敌人技能",true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用R防进突",true).SetValue(true));
                misc.AddItem(new MenuItem("fastEscape", "快速逃跑 = 开, 使用EQ逃跑 = 关",true).SetValue(true));
                misc.AddItem(new MenuItem("escapeDelay", "逃跑延迟减少", true).SetValue(new Slider(0, 0, 300)));
                menu.AddSubMenu(misc);
            }

            //Drawings menu:
            var draw = new Menu("范围显示", "Drawings"); { 
                draw.AddItem(new MenuItem("QRange", "Q范围",true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                draw.AddItem(new MenuItem("QExtendRange", "Q扩展范围",true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                ...
                draw.AddItem(new MenuItem("slaveDmg", "显示小兵攻击范围",true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));

                MenuItem drawComboDamageMenu = new MenuItem("Draw_ComboDamage", "显示连招伤害",true).SetValue(true);
                MenuItem drawFill = new MenuItem("Draw_Fill", "显示连招全部伤害",true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
