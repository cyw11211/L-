...
namespace xSaliceReligionAIO.Champions
{
    class Karthus : Champion
    {
        ...
        {
            //Keys
            var keys = new Menu("按键", "Keys");
            {
                keys.AddItem(new MenuItem("ComboActive", "连招", true).SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
                keys.AddItem(new MenuItem("HarassActive", "消耗", true).SetValue(new KeyBind("S".ToCharArray()[0], KeyBindType.Press)));
                keys.AddItem(new MenuItem("HarassActiveT", "消耗(锁定)", true).SetValue(new KeyBind("Y".ToCharArray()[0], KeyBindType.Toggle)));
                keys.AddItem(new MenuItem("wTar", "使用W", true).SetValue(new KeyBind("W".ToCharArray()[0], KeyBindType.Press)));
            ...
            var spells = new Menu("技能", "Spell"); { 
                ...
                { 
                    ...
                    qMenu.AddItem(new MenuItem("qImmo", "自动Q不动的", true).SetValue(true));
                    qMenu.AddItem(new MenuItem("qDash", "自动Q接近的", true).SetValue(true));
                ...
                {
                    wMenu.AddItem(new MenuItem("wTower", "敌人越塔自动W", true).SetValue(true));
                    wMenu.AddItem(new MenuItem("wIfMana", "有法力就W", true).SetValue(true));
                ...
                {
                    rMenu.AddItem(new MenuItem("rPing", "ping可击杀敌人", true).SetValue(true));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("qHit", "Q命中几率", true).SetValue(new Slider(3, 1, 4)));
            ...
            var harass = new Menu("消耗", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q命中几率", true).SetValue(new Slider(3, 1, 4)));
            ...
            { 
                drawMenu.AddItem(new MenuItem("QRange", "Q范围", true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                drawMenu.AddItem(new MenuItem("WRange", "W范围", true).SetValue(new Circle(true, Color.FromArgb(100, 255, 0, 255))));
                drawMenu.AddItem(new MenuItem("ERange", "E范围", true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                drawMenu.AddItem(new MenuItem("RRange", "R范围", true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                drawMenu.AddItem(new MenuItem("drawUlt", "显示大可击杀", true).SetValue(true));
