...
namespace xSaliceReligionAIO.Champions
{
    class Jayce : Champion
    {
        ...
        {
            //Keys
            var key = new Menu("按键", "Keys"); { 
                key.AddItem(new MenuItem("ComboActive", "连招", true).SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("HarassActive", "消耗", true).SetValue(new KeyBind("S".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("HarassActiveT", "消耗(锁定)", true).SetValue(new KeyBind("Y".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("shootMouse", "鼠标方向QE", true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }

            //Combo menu:
            var combo = new Menu("连招", "Combo"); { 
                combo.AddItem(new MenuItem("UseQCombo", "使用炮形Q", true).SetValue(true));
                combo.AddItem(new MenuItem("qSpeed", "QE 速度 高=更快 低=准确", true).SetValue(new Slider(1600, 400, 2500)));
                combo.AddItem(new MenuItem("UseWCombo", "使用炮形W", true).SetValue(true));
                combo.AddItem(new MenuItem("UseECombo", "使用炮形E", true).SetValue(true));
                combo.AddItem(new MenuItem("UseQComboHam", "使用锤形Q", true).SetValue(true));
                combo.AddItem(new MenuItem("UseWComboHam", "使用锤形W", true).SetValue(true));
                combo.AddItem(new MenuItem("UseEComboHam", "使用锤形E", true).SetValue(true));
                combo.AddItem(new MenuItem("UseRCombo", "使用R开关", true).SetValue(true));
            ...
            var harass = new Menu("消耗", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("UseRHarass", "使用R开关", true).SetValue(true));
            ...
            var misc = new Menu("杂项", "Misc"); { 
                misc.AddItem(new MenuItem("UseInt", "使用E打断技能", true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用E防止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("forceGate", "在E处强行Q", true).SetValue(false));
                misc.AddItem(new MenuItem("gatePlace", "E的距离", true).SetValue(new Slider(300, 50, 600)));
                misc.AddItem(new MenuItem("UseQAlways", "当E正在CD使用Q", true).SetValue(true));
                misc.AddItem(new MenuItem("autoE", " 血量 < %使用E推开", true).SetValue(new Slider(20)));
            ...
            var drawMenu = new Menu("范围显示", "Drawings"); {
                ...
                drawMenu.AddItem(new MenuItem("Draw_Q",  "显示炮形Q范围", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_QExtend", "显示炮形Q扩展", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E",  "显示炮形E范围", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_Q2", "显示锤形Q范围", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E2", "显示锤形E范围", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("drawcds", "显示冷却时间", true).SetValue(true));
