...
namespace xSaliceReligionAIO.Champions
{
    class Blitzcrank : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            {
                qMenu.AddItem(new MenuItem("qRange2", "Q最小距离",true).SetValue(new Slider(300, 1, 950)));
                qMenu.AddItem(new MenuItem("qRange", "Q最大距离",true).SetValue(new Slider(900, 1, 950)));
                qMenu.AddItem(new MenuItem("qSlow", "自动Q缓慢的",true).SetValue(true));
                qMenu.AddItem(new MenuItem("qImmobile", "自动Q不动的",true).SetValue(true));
                qMenu.AddItem(new MenuItem("qDashing", "自动Q接近的",true).SetValue(true));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("qHit", "Q命中",true).SetValue(new Slider(3, 1, 4)));
                combo.AddItem(new MenuItem("UseWCombo", "使用W",true).SetValue(true));
                combo.AddItem(new MenuItem("UseECombo", "使用E",true).SetValue(true));
                combo.AddItem(new MenuItem("QE", "使用E击飞",true).SetValue(true));
                combo.AddItem(new MenuItem("UseRCombo", "使用R",true).SetValue(true));
                combo.AddItem(new MenuItem("useRQ", "使用R后Q",true).SetValue(true));
            ...
            var harass = new Menu("消耗", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q命中",true).SetValue(new Slider(3, 1, 4)));
            ...
            {
                misc.AddItem(new MenuItem("UseInt", "使用R打断技能",true).SetValue(true));
                misc.AddItem(new MenuItem("resetE", "使用E重置普攻",true).SetValue(true));
                misc.AddItem(new MenuItem("autoR", "使用R敌人数量",true).SetValue(new Slider(3, 0, 5)));

                misc.AddSubMenu(new Menu("不使用Q", "intR"));
