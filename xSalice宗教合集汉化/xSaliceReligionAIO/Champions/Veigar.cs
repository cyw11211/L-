    ...
    class Veigar : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("按键", "Keys");
            {
                ...
                key.AddItem(new MenuItem("LastHitQQ2", "Q补兵(锁定)", true).SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("wPoke", "W被晕敌人", true).SetValue(new KeyBind("N".ToCharArray()[0], KeyBindType.Toggle)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("waitW", "W后立即E", true).SetValue(true));
            ...
            var misc = new Menu("杂项", "Misc"); { 
                ...
                misc.AddItem(new MenuItem("UseGap", "使用W防止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("overKill", "击杀检测", true).SetValue(true));
                misc.AddItem(new MenuItem("smartKS", "使用智能击杀系统", true).SetValue(true));

                misc.AddSubMenu(new Menu("不使用R", "DontUlt"));
