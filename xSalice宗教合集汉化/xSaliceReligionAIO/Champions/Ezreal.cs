        ...
        private void LoadMenu()
        {
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                var qMenu = new Menu("Q菜单", "QMenu");
                {
                    ...
                    qMenu.AddItem(new MenuItem("Auto_Q_Slow", "自动W减速的",true).SetValue(true));
                    qMenu.AddItem(new MenuItem("Auto_Q_Immobile", "自动W不动的",true).SetValue(true));
                ...
                {
                    eMenu.AddItem(new MenuItem("E_On_Killable", "可击杀使用E",true).SetValue(true));
                ...
                var rMenu = new Menu("R菜单", "RMenu");
                {
                    ...
                    rMenu.AddItem(new MenuItem("R_Mec", "R击中 >=",true).SetValue(new Slider(3, 1, 5)));
